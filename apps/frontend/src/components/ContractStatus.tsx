...
const CONTRACT_ADDRESSES = {
  ...
  PropertyRegistryRateLimit: process.env.NEXT_PUBLIC_RATE_LIMIT_ADDRESS || '0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9',
  PropertyRegistryAnalytics: process.env.NEXT_PUBLIC_ANALYTICS_ADDRESS || '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9',
  PropertyRegistryGovernance: process.env.NEXT_PUBLIC_GOVERNANCE_ADDRESS || '0x5FC8d32690cc91D4c39d9d3abcBD16989F875707',
...
export function ContractStatus() {
  ...
  const contractDefinitions = [
    ...
    {
      name: 'PropertyRegistryRateLimit',
      address: CONTRACT_ADDRESSES.PropertyRegistryRateLimit,
    ...
    {
      name: 'PropertyRegistryGovernance',
      address: CONTRACT_ADDRESSES.PropertyRegistryGovernance,
